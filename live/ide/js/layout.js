    ...
    content: [{
      ...
      content: [{
        ...
        content: [{
          type: "component",
          componentName: "stdin",
          title: "Dữ liệu đầu vào (STD Input)",
          isClosable: false,
          componentState: {
            readOnly: false
          }
...
$(document).ready(function () {
  console.log("Hey, HC-IDE is open-sourced: https://github.com/HoanChan/. Have fun!");
